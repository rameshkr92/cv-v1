(function(){
    ...
    var formatDate = require('./api/services/formatDate');
    var formatTime = require('./api/services/formatTime');
    ...
    // View paths
    //app.set('views', [path.join(__dirname, './client/views'), path.join(__dirname, './test')]);
    ...
    routes = require('./api/config/routes/routes')(app, io);
